...
trigger: 用户要求处理FDA监管事务，提到FDA、510(k)、PMA、QSR、HIPAA、医疗器械注册、FDA合规评估、FDA检查准备等
do-not-trigger: 用户要求处理MDR法规、ISO认证、非医疗器械相关的法规事务，或与FDA监管无关的编码任务
user-invocable: true
---
...
2. **Technical Safeguard Implementation**
   ...
   - Audit control systems validation
   - Transmission security implementation
   - Integrity controls verification
...
### scripts/
- `fda-pathway-analyzer.py`: FDA regulatory pathway analysis tool
- `qsr-compliance-checker.py`: QSR compliance assessment tool
- `hipaa-assessment-tool.py`: HIPAA compliance evaluation tool

### references/
- `fda-pathway-guide.md`: Comprehensive FDA submission preparation framework
- `qsr-requirements.md`: 21 CFR 820 compliance implementation guide
- `hipaa-compliance-guide.md`: Complete HIPAA compliance requirements
- `510k-submission-guide.md`: 510(k) submission preparation guide

### assets/templates/
- `510k-submission-checklist.md`: 510(k) submission checklist
- `QSR-gap-analysis.md`: QSR compliance gap analysis template
- `HIPAA-risk-assessment.md`: HIPAA risk assessment template
